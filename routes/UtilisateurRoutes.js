...
router.get('/utilisateurs/profil', authenticate, (req, res) => {
  res.set('Cache-Control', 'no-store'); // Désactiver le cache pour cette route
  utilisateurController.getUserProfile(req, res);
});
